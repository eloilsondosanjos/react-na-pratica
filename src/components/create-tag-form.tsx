...
type CreateTagShema = z.infer<typeof createTagSchema>
...
export function CreateTagForm() {
  ...
  const { register, handleSubmit, watch, formState } = useForm<CreateTagShema>({
  ...
  const { mutateAsync } = useMutation({
    mutationFn: async ({ title }: CreateTagShema) => {
  ...
  async function createTag({ title }: CreateTagShema) {
